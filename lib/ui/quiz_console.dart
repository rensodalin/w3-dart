...
//     while (true) {
//       // Step 1: Player enters their name
...
//       // Step 2: Player answers the quiz
//       List<Answer> answers = [];
...
//           answers.add(Answer(question: question, answerChoice: userInput));
//         } else {
...
//       // Step 3: Submit player's answers
//       gameController.submitQuiz(playerName, answers);
//       var currentPlayer = gameController.players[playerName]!;

//       // Step 4: Show current player's detailed result (3 lines)
//       print(' ${playerName} , your score in percentage: ${currentPlayer.score} %');
//       print(' ${playerName} , your score in points : ${currentPlayer.points} %');
//       print(' player : ${playerName} , score : ${currentPlayer.points}\n');

//       // Step 5: Show the full scoreboard (one line per player)
//       var allScores = gameController.getPlayerScores(); // List<MapEntry<String, Player>>

//       for (var entry in allScores) {
//         print('player : ${entry.key} , score : ${entry.value.points}');
//       }
//       print('');
//     }
//   }
